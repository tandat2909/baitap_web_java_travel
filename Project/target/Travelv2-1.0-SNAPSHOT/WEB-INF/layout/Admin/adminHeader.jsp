                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#" class="grid">
                                        <div class="user_img"><img src="<c:url value="/admin/images/avatar1.jpg"/>" alt=""></div>
                                    ...
                                    <li class="odd"><a href="#" class="grid">
                                        <div class="user_img"><img src="<c:url value="/admin/images/avatar2.jpg"/>" alt=""></div>
                                        <div class="notification_desc">
                                    ...
                                    <li><a href="#" class="grid">
                                        <div class="user_img"><img src="<c:url value="/admin/images/avatar3.jpg"/>" alt=""></div>
                                        <div class="notification_desc">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenu3" aria-haspopup="true"
                                   aria-expanded="false">
                                    <div class="profile_img">
                                        <img src="<c:url value="/admin/images/profileimg.jpg"/>" class="rounded-circle" alt="" />
