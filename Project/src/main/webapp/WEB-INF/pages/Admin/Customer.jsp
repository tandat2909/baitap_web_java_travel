...
<%--                        <jsp:useBean id="lsCustomer" scope="request" type="java.util.List<Customer>"/>--%>
                        <c:forEach items="${lsCustomer}" var="i">
                                <div class="col-lg-3 col-md-6 mb-4 px-2" id ="${i.customerId}">
                                    <div class="card text-center card_border py-2">
                                        <div class="btn_delete" title="Xóa" onclick="" >x </div>
                                        <div class="card-body">
                                            <div class="team-main-19">
                                                ...
                                                <div class="right-team-9">
                                                    <div>
                                                        <h5><a href="#url" class="card__title mb-2 mt-3">${i.lastName} ${i.firstName}</a>
                                                        </h5>
