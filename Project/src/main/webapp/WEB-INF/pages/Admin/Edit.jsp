                        ...
                        <c:forEach items="${lsTour}" var="i">
                            ...
                            <div class="col-lg-4 col-md-6 mb-4 search-tour " id="${i.tourId}"  >
                                <div class="card card_border" <%--onclick="openLink('${pageContext.request.contextPath}/tour?tourid=${i.tourId}','_blank')" title="Click để xem chi tiết"--%> >
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title" onclick="edit(this)">${i.tourName}</h5>
                                        <p class="card-text mt-1" onclick="edit(this)"><i class="fa fa-dollar"></i> Giá: <span class="price">${i.price} VNĐ</span></p>
                                        <p class="card-text mt-1"> Số chỗ: ${i.maxseats}</p>
                                        <p class="card-text mt-1" onclick="edit(this)"><i class="fa fa-calendar"></i> Ngày đi: ${i.startDay.date}-${i.startDay.month +1}-${i.startDay.year + 1900}</p>
                                    </div>
                                </div>
