...
<div class="graphs">
    ...
    <div class="span_11">
        <div class="col-md-6 col_4">
            ...
            <!----Calender -------->
            <link rel="stylesheet" href="<c:url value="/admin/css/clndr.css"/>" type="text/css" />
            <script src="<c:url value="/admin/js/underscore-min.js"/>" type="text/javascript"></script>
            <script src="<c:url value="/admin/js/moment-2.2.1.js"/>" type="text/javascript"></script>
            <script src="<c:url value="/admin/js/js/clndr.js"/>" type="text/javascript"></script>
            <script src="<c:url value="/admin/js/site.js"/>" type="text/javascript"></script>
            <!----End Calender -------->
        </div>
        <div class="col-md-6 col_5">
            ...
            <!-- map -->
            <link href="<c:url value="/admin/css/jqvmap.css"/>" rel='stylesheet' type='text/css' />
            <script src="<c:url value="/admin/js/jquery.vmap.js"/>"></script>
            <script src="<c:url value="/admin/js/jquery.vmap.sampledata.js"/>" type="text/javascript"></script>
            <script src="<c:url value="/admin/js/jquery.vmap.world.js"/>" type="text/javascript"></script>
